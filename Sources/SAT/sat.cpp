...
//-------------------------------------------------------------------------
        ...
        while(gpstest == 0) {
            ...
            send_float(socket, *(tabaccel+1),'2','I', PORT, address);
            send_float(socket, *(tabaccel+2),'3','I', PORT, address);
            send_float(socket, *(tabgyr),'4','I', PORT, address);
            send_float(socket, *(tabgyr+1),'5','I', PORT, address);
            send_float(socket, *(tabgyr+2),'6','I', PORT, address);
            send_float(socket, *(tabmag),'7','I', PORT, address);
            send_float(socket, *(tabmag+1),'8','I', PORT, address);
            send_float(socket, *(tabmag+2),'9','I', PORT, address);
            ...
            if(gps.decodeSingleMessage(Ublox::NAV_POSLLH, pos_data) == 1){
                ...
                send_float(socket, (float)pos_data[0],'1', 'G', PORT, address);
                send_float(socket, (float)pos_data[1],'2', 'G', PORT, address);
                send_float(socket, (float)pos_data[2],'3', 'G', PORT, address);
                send_float(socket, (float)pos_data[3],'4', 'G', PORT, address);
                send_float(socket, (float)pos_data[4],'5', 'G', PORT, address);
                send_float(socket, (float)pos_data[5],'6', 'G', PORT, address);
                send_float(socket, (float)pos_data[6],'7', 'G', PORT, address);
                /*The data decoded*/
            ...
            // amount of time. 
            send_float(socket, returntemp(fileT),'1','T', PORT, address);
            usleep(500);
            //printf("%f", *tabaccel);
        }
    }
